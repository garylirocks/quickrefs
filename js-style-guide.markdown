...
- use function expressions instead of function declarations, _function declaration is hoisted_
...
- Whenever you fix a bug, write a _regression test_. A bug fixed without a regression test is almost certainly going to break again in the future
